...
- **Docs are not process artifacts.** 40 markdown files including 10 `TEST_REPORT_*.md` and 4 `VERIFICATION_REPORT_*.md` (originally recorded as 11; recounted at `6b52410`), against **zero tests**. Keep README + DEPLOYMENT + API; delete the rest.
